...
//    @Before
//    public void setup() {
//        when(mockCardholderDAO.findById(3L)).thenReturn(Optional.of(cardholderFixture));
//        when(mockCardholderDAO.findById(4L)).thenReturn(Optional.<Cardholder>absent());
//    }
//
//    @After
...
//
//    @Test
//    public void getCardholderSuccess() throws IOException {
//        Cardholder cardholder =
//                resources.client().target("/cardholders/3").request().get(Cardholder.class);
//        assertThat(cardholder)
//                .isEqualTo(cardholderFixture);
//        verify(mockCardholderDAO).findById(3L);
//    }
//
//    @Test
//    public void getCardholderNotFound() {
...
//        verify(mockCardholderDAO).findById(4L);
//    }
//}